...
from common.ExporterTypes import TX_TYPE_SOL_INIT_ACCOUNT, TX_TYPE_SOL_CLOSE_ACCOUNT
from sol.constants import (
    PROGRAM_SPL_ASSOCIATED_TOKEN_ACCOUNT, INSTRUCTION_TYPE_CREATE_ACCOUNT, INSTRUCTION_TYPE_INITIALIZE,
    INSTRUCTION_TYPE_INITIALIZE_ACCOUNT, INSTRUCTION_TYPE_CLOSE_ACCOUNT, PROGRAM_SPL_TOKEN,
)
