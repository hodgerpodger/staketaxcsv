...
from staketaxcsv.settings_csv import (
    TICKER_ALGO, TICKER_ATOM, TICKER_BLD, TICKER_BTSG, TICKER_CELESTIA, TICKER_DVPN,
    TICKER_EVMOS, TICKER_FET, TICKER_COSMOSPLUS, TICKER_HUAHUA, TICKER_IOTEX, TICKER_JUNO,
    TICKER_KUJI, TICKER_LUNA1, TICKER_LUNA2, TICKER_MNTL, TICKER_OSMO, TICKER_REGEN,
    TICKER_ROWAN, TICKER_SCRT, TICKER_SOL, TICKER_STARS, TICKER_TORI, TICKER_KYVE)
...
import staketaxcsv.report_celestia
...
REPORT_MODULES = {
    ...
    TICKER_CELESTIA: staketaxcsv.report_celestia,
