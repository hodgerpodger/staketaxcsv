...
from staketaxcsv.settings_csv import (
    ...
    TICKER_OSMO, TICKER_REGEN, TICKER_SIFCHAIN, TICKER_SOL, TICKER_STARS, TICKER_TORI)
    TICKER_OSMO, TICKER_REGEN, TICKER_SECRET, TICKER_SOL, TICKER_STARS, TICKER_TORI)
