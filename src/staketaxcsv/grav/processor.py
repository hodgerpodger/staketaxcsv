...
import staketaxcsv.grav.constants as co
import staketaxcsv.common.ibc.handle
import staketaxcsv.common.ibc.processor
from staketaxcsv.grav.config_grav import localconfig
from staketaxcsv.settings_csv import GRAV_NODE
...
def process_tx(wallet_address, elem, exporter):
    txinfo = staketaxcsv.common.ibc.processor.txinfo(wallet_address, elem, co.MINTSCAN_LABEL_GRAV, GRAV_NODE)
    txinfo.url = "https://www.mintscan.io/gravity-bridge/tx/{}".format(txinfo.txid)
