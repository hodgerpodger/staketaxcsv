...
def wallet_exists(wallet_address):
    return staketaxcsv.common.ibc.api_lcd.LcdAPI_v1(KUJI_NODE).account_exists(wallet_address)


def txone(wallet_address, txid):
    elem = staketaxcsv.common.ibc.api_lcd.LcdAPI_v1(KUJI_NODE).get_tx(txid)
